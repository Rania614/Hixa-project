...
const CompanyLogin = () => {
  ...
  // Temporarily disable company login form
  return (
      ...
      <Card className="w-full max-w-md glass-card relative z-10 border-hexa-border">
        <CardHeader className="text-center">
          <CardTitle className="text-3xl font-bold text-hexa-text-dark">
            {language === 'en' ? 'Company access disabled' : 'دخول الشركات مغلق حالياً'}
          </CardTitle>
          <CardDescription className="text-hexa-text-light">
            {language === 'en'
              ? 'Company login and registration are currently disabled. Please contact the platform administration.'
              : 'تسجيل الدخول والتسجيل للشركات مغلقان حالياً. يرجى التواصل مع إدارة المنصة.'}
          </CardDescription>
        </CardHeader>
