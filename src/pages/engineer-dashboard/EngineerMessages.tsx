                        ...
                        <div className="space-y-2">
                          {messages.map((msg, idx) => {
                            ...
                            return (
                              <div
                                key={msg._id}
                                className={`flex items-end gap-2.5 ${isMe ? "justify-end" : "justify-start"} ${isSameSender ? 'mt-0.5' : 'mt-4'}`}
                              >
                                ...
                                <div className={`flex flex-col ${isMe ? "items-end" : "items-start"} max-w-[75%] md:max-w-[70%]`}>
                                            ...
                                            >
                                              ...
                                              <div className="flex-1 min-w-0">
                                                <p className={`text-xs font-medium truncate ${
                                                  isMe ? "text-blue-100" : "text-slate-200"
                                                }`}>
                                                  {att.filename || att.name || 'File'}
                                                </p>
                                                {fileSize && (
                                                  <p className={`text-[10px] opacity-70 ${
                                                    isMe ? "text-blue-200/70" : "text-slate-300/70"
                                                  }`}>{fileSize}</p>
                                                )}
                                              </div>
                                  ...
                                  {isMe && (
                                    <Avatar className={`w-9 h-9 flex-shrink-0 transition-opacity ml-2 ${!isSameSender ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
                                      <AvatarFallback className="bg-blue-600/30 text-blue-200 border border-blue-500/40 text-xs font-semibold">
