...
const EngineerDashboard = () => {
  ...
  const stats = [
    { label: language === "en" ? "Active Projects" : "المشاريع النشطة", value: "8", icon: FileText, description: language === "en" ? "Projects you're working on" : "المشاريع التي تعمل عليها", path: "/engineer/projects?tab=inProgress" },
    { label: language === "en" ? "Submitted Proposals" : "العروض المقدمة", value: "12", icon: Send, description: language === "en" ? "Proposals you've submitted" : "العروض التي قدمتها", path: "/engineer/projects?tab=waitingForAdminDecision" },
    { label: language === "en" ? "Completed Projects" : "المشاريع المكتملة", value: "24", icon: CheckCircle, description: language === "en" ? "Projects you've completed" : "المشاريع التي أكملتها", path: "/engineer/projects?tab=completed" },
    { label: language === "en" ? "Available Projects" : "المشاريع المتاحة", value: "24", icon: Briefcase, description: language === "en" ? "Projects you can apply to" : "المشاريع التي يمكنك التقدم عليها", path: "/engineer/available-projects" },
  ];
                    ...
                    {project.status === "inProgress" && (
                      <div className="flex gap-2 mt-4">
                        <Button
                          ...
                          onClick={(e) => {
                            e.stopPropagation();
                            navigate(`/engineer/messages?project=${project.id}`);
                          }}
